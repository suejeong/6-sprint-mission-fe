...
import Writer from "@/components/ui/article/detail/Writer";
	...
	return (
		<div>
			<div className="flex sm:flex-col md:flex-row gap-4  mb-10">
				<div className="md:flex-1/2">
					<Image
						...
						alt={product?.tags ? product.tags : "상품 이미지"}
				...
				<div className="md:flex-1/2">
					<div className="flex justify-between">
						<div className="flex-1">
							<div className="font-bold sm:text-base md:text-xl lg:text-2xl mb-2 lg:mb-4">
								{product.name}
							</div>
							<div className="font-bold sm:text-2xl md:text-[32px] lg:text-[40px]">
            ...
            "
						...
						<div
							className="border-gray-300 mt-6 mb-2 font-bold text-sm
            "
						>
							상품 태그
						</div>
						<div className="flex gap-1 min-h-9">
							{product.tags?.map((tag, index) => (
								<span
									key={index}
									className=" bg-[#F3F4F6] py-1 px-4 text-base rounded-full"
								>
									#{tag.trim()}
								</span>
							))}
					...
					<div className="flex justify-between items-center">
						<div className="flex justify-between items-center gap-4">
							<div>
								<Image src={ic_profile} alt="프로필 이미지" />
							</div>
							<div>
