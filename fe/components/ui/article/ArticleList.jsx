...
import FormatedDate from "@/components/common/FormattedDate";
		...
		<div>
			{articles.map((article) => (
				<div
					...
					className="cursor-pointer border-b-1 border-[#E5E7EB]"
				>
					<div className="flex justify-between h-18">
						<h2 className="sm:text-lg font-[600]">
							{article.title}
						</h2>
					...
					<div className="mt-4 mb-6 flex justify-between items-center gap-2">
						...
						<div className="flex justify-between items-center gap-2">
							<Image
								...
								className="h-4 w-5"
							/>
							<span className="sm:text-sm font-[#6B7280] font-[400]">
								9999+
							</span>
						</div>
					</div>
