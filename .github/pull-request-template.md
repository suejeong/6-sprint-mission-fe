...
- HTML 코드 정리가 깔끔하지 못한 것 같습니다. 어떻게 정리하면 좋을지 알려주시면 감사하겠습니다.
- 여러 군데에 동일하게 스타일이 적용되는 곳은 클래스로 묶어서 CSS 스타일을 입혔는데 애매하게 한개만 존재하는 곳은 inline으로 스타일을 적용 시켰습니다. 한개만 존재하더라도 CSS에서 스타일 적용하는게 좋을까요?
